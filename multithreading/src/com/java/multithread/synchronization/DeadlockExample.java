...
class Task2 implements Runnable{
    ...
    @Override
    public void run() {
        synchronized (pen){ //to resolve deadlock, we implement consistent ordering for acquiring lock
            //now thread2 will get paper lock only when it has pen lock
...
public class DeadlockExample {
    ...
    public static void main(String[] args) {
        ...
        //Because of circular dependency it causes deadlock
        thread1.start();
        thread2.start();
    }
